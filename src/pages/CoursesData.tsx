...
interface Course {
  ...
  progress?: number;
  courseLinks?: { id?: string; title?: string; url?: string; type?: string }[];
}
...
exercises: [
  ...
  },
  {
    ...
    views: 3100,
    preview:
      "Easy-to-understand guide on the concept of limits in calculus. Includes solved examples and practice problems.",
